...
- Separate executable-ledger reference replay passed 6 source-bound cases, including real process contention/crash and blocked unsafe starts. This is separate from the 43 operator cases and the three-script coverage denominator; exhaustive reference-code coverage is not claimed.
