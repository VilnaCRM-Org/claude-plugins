...
class TestNM2SkillName(NamingTestBase):
    ...
    def test_edge_title_case_h1_not_compared(self):  # E -> PASS
        self.skill(
            "deptrac-fixer", name="deptrac-fixer", h1="Deptrac Fixer Skill"
        )
        self.assertEqual([], self.lint())
...
class TestNM5KebabCase(NamingTestBase):
    def test_positive(self):  # P
        self.agent(
            "pr-comment-resolver", name="pr-comment-resolver",
    ...
    def test_negative_snake_pascal(self):  # N
        ...
        self.agent(
            "pr-comment-resolver", name="PR_Comment_Resolver",
    ...
    def test_edge_digits_allowed(self):  # E -> PASS
        self.agent(
            "bmad-fr-nfr-review-gate", name="bmad-fr-nfr-review-gate",
