...
| PHPUnit   | Line coverage   | enforced via `quality.infection_msi` — uncovered mutants escape, so a 100 MSI floor implies full coverage | [testing-workflow](../testing-workflow/SKILL.md)                                                      |
